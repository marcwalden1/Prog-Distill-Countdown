...
- **GPUs:** `nvidia_h100_80gb_hbm3`, 96 GB each
...
| What | Path |
|---|---|
| Repo root | `/n/home06/mwalden/RL-skill-comp` |
| Models | `/n/holylabs/LABS/kdbrantley_lab/Lab/mwalden/models/{MODEL_NAME}` |
| Checkpoints | `/n/holylabs/LABS/kdbrantley_lab/Lab/mwalden/rl-checkpoints/checkpoints/{MODEL_NAME}/{exp_name}` |
...
| `CHECKPOINT_DIR` | `/n/holylabs/.../rl-checkpoints` | Checkpoint base dir |
...
# Create balanced train/test parquets
